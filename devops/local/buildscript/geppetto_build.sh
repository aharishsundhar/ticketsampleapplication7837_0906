...
APPLICATION='/ticketsampleapplication7837'
...
DESKTOPIMAGENAME='geppettotest/ticketsampleapplication7837-desktop:1.0'
...
helm install --name ticketsampleapplication7837-0906 ./helm
if [ $? -eq 0 ]; then
